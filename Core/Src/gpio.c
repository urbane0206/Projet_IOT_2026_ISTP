...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : MAG_SW_Pin RST_Pin */
  GPIO_InitStruct.Pin = MAG_SW_Pin|RST_Pin;
  ...
  /*Configure GPIO pins : PIR_Pin BPJaune_Pin */
  GPIO_InitStruct.Pin = PIR_Pin|BPJaune_Pin;
